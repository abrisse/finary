...
describe Finary::User do
  ...
  describe '#add_generic_asset' do
    subject(:add_generic_asset) do
      user.add_generic_asset(params)
    end
    ...
    it 'returns the generic asset' do
      expect(add_generic_asset).to be_an_instance_of(Finary::GenericAsset)
    end
  end

  describe '#update_generic_asset' do
    subject(:update_generic_asset) do
      user.update_generic_asset(42, params)
    end
    ...
    let(:finary_client) do
      instance_double(Finary::Client, update_user_generic_asset: attributes)
    end
    ...
    it 'returns the generic asset' do
      expect(update_generic_asset).to be_an_instance_of(Finary::GenericAsset)
    end
  end

  describe '#delete_generic_asset' do
    subject(:delete_generic_asset) do
      user.delete_generic_asset(42)
    end
